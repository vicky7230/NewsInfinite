...
public class SearchNewsListAdapter extends BaseAdapter {
    ...
    public SearchNewsListAdapter(Context context, List<Result> resultList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (resultList.get(position).getWebPublicationDate() != null) // to avoid replace() being called on null string
